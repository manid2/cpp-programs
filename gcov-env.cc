...
int main(int argc, char **argv)
{
	 ...
	 * environment variables in shell as it localizes the process
	 * environment and works well when the process is started by a fork()
	 * & exec().
	 *
	 * In case of fork() and exec() the environment variables will be same
	 * as they are in parent process which may not be under our control.
	 *
